...
/// </summary>
[Virtual]
public class ImagedLabel : BoxContainer
{
    ...
    private Label _centeredLabel = new Label();
    ...
    public Label CenteredLabel { get => _centeredLabel; set { RemoveChild(1); AddChild(value); value.SetPositionInParent(1); } }
